...
function BoardGame() {
    ...
    useEffect(() => {
        ...
        // Fetch the leaderboard from local storage
    ...
    // update the leaderboard in the local storage
    function updateLeaderBoard (newPlayer) {
        let updatedLeaderBoard = [...leaderBoard, newPlayer];
        localStorage.setItem('leaderBoard', JSON.stringify(updatedLeaderBoard));
        setLeaderBoard(leaderBoardSlice(updatedLeaderBoard));
    };
    ...
    function handleSubmit() {
        ...
        const newPlayer = { nickname: nickname, time: formatTime(time) };
